...
from .serializers import AnswerSerializer, ResponseAnswerSerializer
...
class AnswerViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        ...
        responses={201: ResponseAnswerSerializer()},
    )
    def perform_create(self, request, *args, **kwargs):
        ...
        response_serializer = ResponseAnswerSerializer(instance, context={"request": request})
